...
@section('content')
    <main id="produto">
        <section id="solucoes" class="produto-detalhe py-lg-4 py-2">
            <div class="container">
                <div class="row ">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center">
                        <div class="swiper produto-detalhe-swiper" data-aos="fade-left">
                            <div class="swiper-wrapper">
                                
                                    @foreach (range(0,4) as $image)
                                        <div class="swiper-slide p-1">
                                            <div class="ratio ratio-1x1">
                                                <img class="w-100 h-100 object-fit-cover rounded-40" src="{{ asset('front/images/backgrounds/windel-compacto.png') }}" alt="Logo {{ env('APP_NAME') }}"> 
                                            </div>
                            ...
                            <div class="swiper-button-prev rounded-circle bg-danger w-35 h-35 start-30">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M24 12L16 20L24 28" stroke="white" stroke-width="1.5" stroke-linejoin="round"/>
                                </svg>                                      
                            </div>
                            <div class="swiper-button-next rounded-circle bg-danger w-35 h-35 end-30">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="cards">
            <div class="container">
                <div class="row d-none d-lg-flex">
                    ...
                    <div class="col-lg-4 col-6 m-auto" data-aos="zoom-in">
                ...
                <div class="row d-lg-none">
                    <div class="swiper windel-swiper">
        ...
        <x-depoimentos />
        <section class="pb-lg-4 pb-2" data-aos="fade-up-left">
            <div class="container">
                <div class="row">
                    <h2 class="w-100 text-center gap-1 d-flex align-items-center justify-content-center my-2 p-600 h2">
        ...
        <section class=" pb-2 pb-lg-4 mb-2" data-aos="fade-down-right">
            <div class="container">
