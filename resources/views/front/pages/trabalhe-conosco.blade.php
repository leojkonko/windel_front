...
@section('content')
    <main id="contato">
        <section class="py-2 py-lg-4 mb-lg-4 mb-3 mb-lg-0 position-relative" id="solucoes">
            ...
            <div class="container">
                <div class="row">
                    <h2 class="text-lg-start text-center h2 p-600 text-primary mb-lg-1 mb--2 pb-2 pb-lg-2 mt-2 mt-lg-0">Vagas disponíveis</h2>
