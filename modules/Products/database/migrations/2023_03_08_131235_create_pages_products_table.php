...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pages_products', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
        });
        Schema::create('pages_products_translations', function (Blueprint $table) {
            $table->id();
            $table->timestamps();

            MigrationUtil::translationsColumns($table, 'pages_products', 'page_product_id');
    ...
    {
        Schema::dropIfExists('pages_products_translations');
        Schema::dropIfExists('pages_products');
    }
};
